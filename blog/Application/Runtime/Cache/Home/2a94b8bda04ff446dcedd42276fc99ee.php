...
<head>
    ...
    <link href="/blog/Public/Home/css/styles.css" rel="stylesheet">
    <link href="/blog/Public/Home/css/animation.css" rel="stylesheet">
    <!-- 返回顶部调用 begin -->
    <link href="/blog/Public/Home/css/lrtk.css" rel="stylesheet" />
    <script type="text/javascript" src="/blog/Public/Home/js/jquery.js"></script>
    <script type="text/javascript" src="/blog/Public/Home/js/js.js"></script>
    <!-- 返回顶部调用 end-->
    <!--[if lt IE 9]>
...
<header>
    <nav id="nav">
        ...
        <script src="/blog/Public/Home/js/silder.js"></script><!--获取当前页导航 高亮显示标题-->
    </nav>
</header>
<!--header end-->
<div id="mainbody">
    <div class="info">
        <figure> <img src="/blog/Public/Home/images/art.jpg"  alt="Panama Hat">
        ...
        <div class="card">
            <h1>我的名片</h1>
            <p>网名：zhouJoice | 笑以歌</p>
            <p>职业：Web前端开发</p>
            <p>电话：17352833397</p>
            <p>Email：zhouyilong0220@163.com</p>
            <ul class="linkmore">
    ...
    <div class="blogs">
        <ul class="bloglist">
            <li>
                <div class="arrow_box">
                    ...
                    <div class="ci"></div>
                    <!--圆形-->
                    <h2 class="title"><a href="/blog/index.php/Home/Index/view.html" target="_blank">我希望我的爱情是这样的</a></h2>
                    <ul class="textinfo">
                        <a href="/"><img src="/blog/Public/Home/images/s1.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <div class="ci"></div>
                    <!--圆形-->
                    <h2 class="title"><a href="/blog/index.php/Home/Index/view.html" target="_blank">谁更心软，谁就先长大</a></h2>
                    <ul class="textinfo">
                        <a href="/"><img src="/blog/Public/Home/images/s2.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <div class="ci"></div>
                    <!--圆形-->
                    <h2 class="title"><a href="/blog/index.php/Home/Index/view.html" target="_blank">Nothing is as sweet as you</a></h2>
                    <ul class="textinfo">
                        <a href="/"><img src="/blog/Public/Home/images/s3.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <h2 class="title"><a href="/blog/index.php/Home/Index/view.html" target="_blank">谁更心软，谁就先长大</a></h2>
                    <ul class="textinfo">
                        <a href="/"><img src="/blog/Public/Home/images/s4.jpg"></a>
                        <p> 男人都是孩子，需要用一生时间来长大。女人都想当孩子，却最擅长的角色是妈妈。恋爱一开始，是两个孩子之间的游戏，到后来，成了大人和孩子之间的游戏。恋爱这回事，总要有一个人先长大，对另一半多些包容和宠溺。而通常来看：谁更心软，谁就先长大...</p>
                    </ul>
                    <ul class="details">
                        <li class="likes"><a href="#">102</a></li>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <div class="ci"></div>
                    <!--圆形-->
                    <h2 class="title"><a href="/blog/index.php/Home/Index/view.html" target="_blank">趁我们都还年轻</a></h2>
                    <ul class="textinfo">
                        <a href="/"><img src="/blog/Public/Home/images/s5.jpg"></a>
        ...
        <aside>
            ...
            <div class="toppic">__PBULIC__/Home/
                <h2>图文并茂</h2>
                <ul>
                    <li><a href="/"><img src="/blog/Public/Home/images/k01.jpg">腐女不可怕，就怕腐女会画画！
                        <p>伤不起</p>
                    </a></li>
                    <li><a href="/"><img src="/blog/Public/Home/images/k02.jpg">问前任，你还爱我吗？无限戳中泪点~
                        <p>感兴趣</p>
                    </a></li>
                    <li><a href="/"><img src="/blog/Public/Home/images/k03.jpg">世上所谓幸福，就是一个笨蛋遇到一个傻瓜。
                        <p>喜欢</p>
                    </a></li>
                </ul>
            </div>
            ...
            <div class="viny">
                <dl>
                    <dt class="art"><img src="/blog/Public/Home/images/artwork.png" alt="专辑"></dt>
                    ...
                    <dd class="music">
                        <audio src="/blog/Public/Home/images/nf.mp3" controls></audio>
                    </dd>
...
<!--mainbody end-->__PBULIC__/Home/
<footer>
    <div class="footer-mid">
        <div class="links">
            <h2>友情链接</h2>
            <ul>
                <li><a href="/">周意龙个人博客</a></li>
                <li><a href="https://github.com/LongJoice/zhouJoice.github.io">技术服务中心</a></li>
            </ul>
        </div>
        <div class="visitors">
            <h2>最新评论</h2>
            <dl>
                <dt><img src="/blog/Public/Home/images/s8.jpg">
                <dt>
                <dd>1
                    <time>49分钟前</time>
                </dd>
                <dd>在 <a href="#" class="title">你在思考什么呢？ </a>中评论：</dd>
                <dd>环境可以改变人的决定，但只要你坚持就不会被环境所改变</dd>
            </dl>
            <dl>
                <dt><img src="/blog/Public/Home/images/s7.jpg">
                <dt>
                <dd>2
                    <time>2小时前</time>
                </dd>
            ...
            <dl>
                <dt><img src="/blog/Public/Home/images/s6.jpg">
                <dt>
                <dd>小林博客
                    <time>8月7日</time>
                </dd>
        ...
        <section class="flickr">
            <h2>摄影作品</h2>
            <ul>
                <li><a href="/"><img src="/blog/Public/Home/images/01.jpg"></a></li>
                <li><a href="/"><img src="/blog/Public/Home/images/02.jpg"></a></li>
                <li><a href="/"><img src="/blog/Public/Home/images/03.jpg"></a></li>
                <li><a href="/"><img src="/blog/Public/Home/images/04.jpg"></a></li>
                <li><a href="/"><img src="/blog/Public/Home/images/05.jpg"></a></li>
                <li><a href="/"><img src="/blog/Public/Home/images/06.jpg"></a></li>
                <li><a href="/"><img src="/blog/Public/Home/images/07.jpg"></a></li>
                <li><a href="/"><img src="/blog/Public/Home/images/08.jpg"></a></li>
                <li><a href="/"><img src="/blog/Public/Home/images/09.jpg"></a></li>
            </ul>
        </section>
    </div>
